        ...
        getOdooData(
          ...
          async (workorders: any) => {
            ...
            getOdooData(
              ...
              ['id', 'state', 'name', 'product_id', 'product_qty', 'qty_producing', 'lot_producing_id', 'date_planned_start', 'user_id', 'bom_id', 'move_raw_ids', 'x_studio_po', 'origin'],
              false,
              false,
              user.company_id,
    ...
    case 'Lider':
      return new Promise(async (resolve, reject) => {
        ...
        getOdooData(
          ...
          ['id','name','state','product_id','product_qty','qty_producing','lot_producing_id','date_planned_start','user_id','bom_id','move_raw_ids', 'x_studio_po', 'origin'],
          false,
          false,
          user.company_id,
          async (productions: any) => {

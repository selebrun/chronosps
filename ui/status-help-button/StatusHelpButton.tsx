...
const STATUS_HELP: Record<string, Array<{ status: string; description: string }>> = {
  ...
  workorder: [
    ...
    { status: 'quality_pending', description: 'Orden pausada mientras espera completar sus controles de calidad.' },
    { status: 'quality_failed', description: 'Orden con control de calidad fallado; requiere correccion por Calidad o liberacion de Lider/Jefe.' },
